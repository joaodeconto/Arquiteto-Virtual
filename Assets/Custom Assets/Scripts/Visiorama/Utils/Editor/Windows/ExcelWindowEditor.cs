...
public class ExcelWindowEditor : EditorWindow {
	
	static ExcelWindowEditor instance;
	...
	static void Init () {
		instance = (ExcelWindowEditor)EditorWindow.GetWindow(typeof(ExcelWindowEditor), false, "Excel Import");
